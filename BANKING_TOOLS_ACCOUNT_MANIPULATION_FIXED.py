#!/usr/bin/env python3
"""
ACCOUNT MANIPULATION TOOL (FIXED)
...
"""
    ...
    def transfer_funds(self):
        ...
        target_account = simpledialog.askstring("Transfer Funds", "Enter target account number:")
        if not target_account:
            return
        
        amount = simpledialog.askinteger("Transfer Funds", "Enter transfer amount:")
        if amount is None:
            return
